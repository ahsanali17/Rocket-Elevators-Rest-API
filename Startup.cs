        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<RestAPIContext>(options =>
                options.UseMySql(
                    ...
                    "server=codeboxx.cq6zrczewpu2.us-east-1.rds.amazonaws.com;user=codeboxx;password=Codeboxx1!;port=3306;database=myapp_development;sslmode=none;ConvertZeroDateTime=True",
